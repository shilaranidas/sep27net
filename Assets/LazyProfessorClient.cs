...
public class LazyProfessorClient : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.C))
            SendMessageToHost(ClientToServerTransferSignifiers.CreateAccount + ",101141958,pass");
        else if (Input.GetKeyDown(KeyCode.L))
            SendMessageToHost(ClientToServerTransferSignifiers.Login + ",101141958,pass");
        else if (Input.GetKeyDown(KeyCode.R))
            SendMessageToHost(ClientToServerTransferSignifiers.SubmitAssignmentOneLink + ",https://github.com/shilaranidas/StreamingDataLab");
            ...
            SendMessageToHost(ClientToServerTransferSignifiers.SubmitDiscordUserName + ",shila_programmer#3887");
